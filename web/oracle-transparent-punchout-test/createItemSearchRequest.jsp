...
<form action="punchoutSetupTester.jsp" method="POST">
    <h3>Mimic an Oracle Transparent Punchout Search Request</h3>

    URL to Test: <input type="text" name="urltotest" size="70" value="http://localhost:8080/opc/oracleTransparentPunchout/search"><br>
